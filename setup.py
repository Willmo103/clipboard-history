...
"""
            ...
            plist_file = launch_agents_dir / "com.clipboard-history-manager.plist"
    ...
    def create_windows_shortcuts(self):
        ...
        try:
            ...
            shortcut.Arguments = f'"{self.script_dir / "clipboard_history_app.py"}"'
...
"""
    ...
    def create_macos_shortcuts(self):
        ...
        try:
            ...
            print(f"   Drag {self.script_dir / 'clipboard_history_app.py'} to Desktop while holding Cmd+Option")
            return True
    ...
    def test_application(self):
        ...
        try:
            ...
            spec = importlib.util.spec_from_file_location("clipboard_app", app_path)
    ...
    def run_setup(self):
        ...
        if success_count == len(steps):
            ...
            print("2. Or run the application manually with the startup scripts")
...
def main():
    ...
    try:
        ...
        if success:
            ...
            print("Please check the error messages above and try manual configuration")
